...
const EmployerSidebar = ({ user, className = "" }: { user: any; className?: string }) => {
    ...
    <div className={`flex flex-col fixed left-0 top-0 h-screen w-64 bg-white border-r border-gray-200 p-4 ${className}`}>
      ...
      <div className="flex flex-col space-y-1 mb-6">
        ...
        <Link href="/employer/dashboard">
          <SidebarItem icon={<LayoutDashboard size={18} />} label="Overview" active={pathname === "/employer/dashboard"} />
        </Link>
